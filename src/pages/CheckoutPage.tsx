...
const CheckoutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-32 flex justify-center">
      <div className="w-full max-w-md">
        ...
        {/* Footer Actions */}
        {step === 'info' && (
          <div className="fixed bottom-0 left-0 right-0 bg-card border-t border-border glass-effect">
