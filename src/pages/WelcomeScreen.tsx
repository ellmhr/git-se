    ...
    <div className="min-h-screen bg-background flex flex-col px-6 py-12">
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        <div className="relative w-64 h-64 mb-8 animate-fade-up">
          {/* Stack of books illustration using CSS */}
        ...
        <h2 className="text-2xl font-bold text-foreground text-center mb-3 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          Selamat Datang di BookBridge
        </h2>
        <p className="text-muted-foreground text-center max-w-xs mb-8 animate-fade-in" style={{ animationDelay: '0.3s' }}>
